...
import LG from '../img/LamGirl.png';
...
const Header = () => {
    ...
    return (
        <header className=" fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary rounded-b-3xl">
            {/* desktop & tablet */}
            <div className="hidden md:flex w-full h-full items-center justify-between">
                <Link to={'/'} className="flex items-center gap-2">
                    <img src={LG} className="w-8 object-cover" alt="logo" />
                    <p className='text-headingColor text-xl font-bold'>Outlaws</p>
                </Link>
                        ...
                        />
                        {
                            isMenu && (
                                <motion.div
                                    ...
                                    {
                                        user && user.email === "richdadtrieu@gmail.com" && (
                                            <Link to={'/createItem'}>
